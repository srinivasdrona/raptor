...
> local untracked notes, pre-build literature review, patient/private content, or any
...
|---|---|---|---|---|
| Post-discovery panel protocol | Administrative protocol v1.0.3, document hash `df9b9a33a4343968c20993feaab6622d129118152cd0c90452936c4b5f81cfc0`, registration hash `d79486b3b74f81d87a3d25c10bd1f0eea31ada562a940d632f4a29ef8574b7b2`; explicitly `is_preregistration: false`; seed and selection rules unchanged from v1.0.2 | `docs/project/atlas/ATLAS_PHASE2_PANEL_SELECTION_PROTOCOL.md`; `docs/project/atlas/atlas-phase2-panel-selection-registration-v1.yaml` | No candidate names/results occur in the protocol | No formal panel has been selected |
| Candidate-universe commitment | Identity-custody lock v1 binds 35 discovered entries: 31 missense alleles, 28 resolved identities and seven unresolved. Evidence-enriched universe v2 adds 37 attributable observations across 32 records while preserving three evidence-absent records; corrected lock-v2 hash `014dedb3ec5006d0faecbf69b64a7676bcb3e256aa162758c33357c7eb805dfa` | `configs/atlas/panels/tsc2/atlas-phase2-candidate-universe-lock-v1.yaml`; `configs/atlas/panels/tsc2/atlas-phase2-candidate-universe-lock-v2.yaml`; `data/atlas/runs/2026-08-03/candidate_universe_v2_summary.json`; `docs/project/TODOS.yaml` | Candidate-bearing universes remain under the external uncommitted content root | Registration v1.0.3 binds lock v2; formal selector is ready but has not run |
...
`grant-anthropic-submission-package`; plus
